...
<!--                            <li class="breadcrumb-item"><a href="javascript:void(0);">Apps</a></li>-->
                            <li class="breadcrumb-item active" aria-current="page"><span style="font-size: 16px;color: #000;padding: 8px 0px;">Messenger</span></li>
                        </ol>
                    </nav>
                        ...
                        <div class="user-list-box">
                            ...
                            <div class="people">
                                ...
                                <div class="person" data-chat="person6">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-4.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person2">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-11.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person3">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-23.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person4">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-7.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person7">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-32.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person8">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-33.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person9">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-21.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person10">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-12.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person" data-chat="person11">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-26.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                                ...
                                <div class="person border-none" data-chat="person12">
                                    <div class="user-info">
                                        <div class="f-head">
                                            <img src="{{asset('/assets/img/profile-20.jpg')}}" alt="avatar">
                                        </div>
                                        <div class="f-body">
                                            <div class="meta-info">
                        ...
                        <div class="chat-box">
                            ...
                            <div class="chat-box-inner">
                                <div class="chat-meta-user">
                                    <div class="current-chat-user-name"><span><img src="{{asset('/assets/img/90x90.jpg')}}" alt="dynamic-image"><span class="name"></span></span></div>
